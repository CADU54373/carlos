...
const Contact = () => {
  ...
  const downloadSourceCode = () => {
    // Simulate downloading source code as ZIP
    const link = document.createElement('a');
    link.href = '#';
    link.download = 'portfolio-source-code.zip';
    
    // In a real implementation, this would generate and download the actual source files
    toast({
      title: "Download iniciado!",
      description: "O código fonte do site está sendo preparado para download.",
    });
  ...
  return (
    <section id="contact" ref={sectionRef} className="min-h-screen flex items-center py-20 px-6" data-scroll-section>
          ...
          <div className="flex flex-col justify-center space-y-8">
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Carlosedduardo239@gmail.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.linkedin.com/in/carlos-eduardo-159120234?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                  target="_blank"
                ...
                <a
                  href="https://wa.me/5515991829775"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:border-green-400/50 transition-all duration-300 hover:scale-110"
                >
                ...
                <button
                  ...
                  className="w-12 h-12 bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:border-blue-400/50 transition-all duration-300 hover:scale-110"
